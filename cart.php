    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            ...
            if (isset($_SESSION['uNickname'])) {
                ...
                $isLoggedIn = true;
                echo "<div class='row justify-content-center mt-3 mb-5'><h2>$name's shopping cart</h2></div>";
            } else {
                //display default layout
                echo "<div class='row justify-content-center'>
                    <h2>Log In to View Cart</h2>
                  </div>";
            }
            ?>
        </div>
        <div class="row justify-content-center">
            ...
            if ($isLoggedIn) {
                ...
                $query2 = "SELECT * FROM cart where u_id=$uid ";
                ...
                if ($result2->num_rows > 0) {
                  ...
                  <div class='card text-white bg-dark mb-3 w-75' >
                                ...
                                <a class='card-body'  href='post.php?pid=" . $row['p_id'] . "'>
                                  <h5 class='card-title' >" . $row['p_title'] . "</h5> 
                                   
                                  <p class='card-text'>$ " . $row['p_price'] . "</p>
                                  <p class='card-body'><img src=images/" . $row['p_image'] . " ></p>
                                <form class='mb-5 w-75' action='includes/remove.inc.php?pid=$p_id ' method='post'>
                                  <button type='submit' name='remove' class='btn btn-primary'>Remove from cart</button>
                                </form>
        ...
        <?php
        echo "<div class='row justify-content-center mt-3 mb-5'><h2>Total: $total </h2></div>";
        ?>
    </div>
